...
// Create a new Temboo session.
            TembooSession session = new TembooSession("fdavey22", "myFirstApp", "0jl44bhvK7ck2BRDxMScTf36Bcr4wDat");
...
// Set inputs
            ...
            sendEmailInputs.set_MessageBody(EXTRA_MESSAGE);
            sendEmailInputs.set_Password("iupmjejxyxrfysnw");
